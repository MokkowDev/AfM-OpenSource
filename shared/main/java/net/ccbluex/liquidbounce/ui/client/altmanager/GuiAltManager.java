...
public class GuiAltManager extends WrappedGuiScreen {
    ...
    public String status = "§7Sub to TheMosKau and phupham yes yes";
    ...
    public static String login(final MinecraftAccount minecraftAccount) {
        ...
        if (minecraftAccount.isCracked()) {
            ...
            MCLeaks.remove();
            return "§cLogin as §8" + minecraftAccount.getName() + "§c.";
        }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        Fonts.font35.drawCenteredString(this.searchField.getText().isEmpty() ? (LiquidBounce.fileManager.accountsConfig.getAccounts().size() + " Alts total") : this.altsList.accounts.size() + " Search Results", representedScreen.getWidth() / 2.0f, 18, 0xffffff);
