...
class GuiBackground(val prevGui: IGuiScreen) : WrappedGuiScreen() {
        ...
        when (button.id) {
            ...
            3 -> {
                ...
                try {
                    ...
                    val location = classProvider.createResourceLocation("Mossware-1.8/background.png")
    ...
    override fun drawScreen(mouseX: Int, mouseY: Int, partialTicks: Float) {
        ...
        Fonts.risemainmenu.drawCenteredString("Background", this.representedScreen.width / 2F, representedScreen.height / 8F + 5F,
            Color(0,255,0, 80).rgb, false)
