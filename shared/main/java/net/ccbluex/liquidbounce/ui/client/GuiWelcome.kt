...
class GuiWelcome : WrappedGuiScreen() {
    ...
    override fun drawScreen(mouseX: Int, mouseY: Int, partialTicks: Float) {
        ...
        font.drawCenteredString("Thank you for downloading and installing the client!", representedScreen.width / 2F, representedScreen.height / 8F + 70, 0xffffff, true)
        font.drawCenteredString("Here is some information you might find useful if you are using afm (liquidbounce custom) for the first time.", representedScreen.width / 2F, representedScreen.height / 8F + 70 + font.fontHeight, 0xffffff, true)
        ...
        font.drawCenteredString("Discord: rdeef#1364", representedScreen.width / 2F, representedScreen.height / 8F + 80 + font.fontHeight * 13, 0xffffff, true)
        font.drawCenteredString("Discord server: lazy to add", representedScreen.width / 2F, representedScreen.height / 8F + 80 + font.fontHeight * 14, 0xffffff, true)

        super.drawScreen(mouseX, mouseY, partialTicks)

        // Title
        GL11.glScalef(2F, 2F, 2F)
        Fonts.risemainmenu.drawCenteredString("Welcome! to mossware (first time)", representedScreen.width / 2 / 2F, representedScreen.height / 8F / 2 + 20, Color(0, 140, 255).rgb, true)
    }
