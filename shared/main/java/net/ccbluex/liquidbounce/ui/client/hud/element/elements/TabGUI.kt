...
class TabGUI(x: Double = 5.0, y: Double = 25.0) : Element(x = x, y = y) {
    ...
    private val redtextValue = IntegerValue("Text Red", 210, 0, 255)
    private val greentextValue = IntegerValue("Text Green", 210, 0, 255)
    private val bluetextValue = IntegerValue("Text Blue", 210, 0, 255)
    ...
    override fun drawElement(): Border? {
        ...
        tabs.forEachIndexed { index, tab ->
            ...
            val textColor = if (selectedCategory == index) 0xffffff else Color(redtextValue.get(), greentextValue.get(), bluetextValue.get()).rgb
