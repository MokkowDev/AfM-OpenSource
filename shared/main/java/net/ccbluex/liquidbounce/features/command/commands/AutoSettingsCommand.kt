...
class AutoSettingsCommand : Command("onlineconfig", "setting", "settings", "settingsonline", "autosetting") {
        ...
        when {
            ...
            args[1].equals("load", ignoreCase = true) -> {
                ...
                val url = if (args[2].startsWith("http"))
                    ...
                    "${LiquidBounce.CLIENT_WEBSITE}LiquidBounce/settings/${args[2].toLowerCase()}"
            ...
            synchronized(loadingLock) {
                ...
                try {
                    val json = JsonParser().parse(HttpUtils.get(
                            ...
                            "https://api.github.com/repos/TheMosKau/AfM-Data/contents/LiquidBounce/settings"
                    ))
