...
abstract class Command(val command: String, vararg val alias: String) : MinecraftInstance() {
     ...
     * Print [msg] to chat
     */
    protected fun chat(msg: String) = ClientUtils.displayChatMessage("§6Autodie for mossware §c> §3$msg")

    /**
     * Print [syntax] of command to chat
     */
    protected fun chatSyntax(syntax: String) = ClientUtils.displayChatMessage("§6Autodie for mossware §c> §3Syntax: §7${LiquidBounce.commandManager.prefix}$syntax")

    /**
     * Print [syntaxes] of command to chat
     */
    protected fun chatSyntax(syntaxes: Array<String>) {
        ClientUtils.displayChatMessage("§6Autodie for mossware §c> §3Syntax:")
     ...
     */
    protected fun chatSyntaxError() = ClientUtils.displayChatMessage("§6Autodie for mossware §c> §3Syntax error")
