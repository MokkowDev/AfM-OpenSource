    ...
    fun onRender2D(event: Render2DEvent) {
        if (counterDisplayValue.get()) {
            ...
            RenderUtils.drawBorderedRect(scaledResolution.scaledWidth / 2 - 2.toFloat(),
                ...
                scaledResolution.scaledWidth / 2 + Fonts.flux.getStringWidth(info) + 2.toFloat(),
                scaledResolution.scaledHeight / 2 + 16.toFloat(), 3f, Color.TRANSLUCENT, Color.TRANSLUCENT)

            classProvider.getGlStateManager().resetColor()

            Fonts.flux.drawStringWithShadow(info, scaledResolution.scaledWidth / 2,
