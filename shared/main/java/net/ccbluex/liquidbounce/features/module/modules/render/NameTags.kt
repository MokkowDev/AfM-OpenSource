...
class NameTags : Module() {
    ...
    private val fontValue = FontValue("Font", Fonts.rise)
    ...
    private fun renderNameTag(entity: IEntityLivingBase, tag: String) {
        ...
        val healthText = if (healthValue.get()) "§7§c " + entity.health.toInt() + " Health" else ""
        val botText = if (bot) " §c§lSussy bot" else ""
