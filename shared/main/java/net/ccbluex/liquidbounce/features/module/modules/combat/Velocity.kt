...
class Velocity : Module() {
    ...
    private val modeValue = ListValue("Mode", arrayOf("Normal", "Cancel", "AAC", "AAC3", "AACZero", "Redesky",
            "Reverse", "SmoothReverse", "Jump", "HeroMC", "Glitch"), "Normal")
    ...
    // AAC Push
    private val aacPushXZReducerValue = FloatValue("AACv3XZReducer", 2F, 1F, 3F)
    private val aacPushYReducerValue = BoolValue("AACv3YReducer", true)
    ...
    fun onUpdate(event: UpdateEvent) {
        ...
        when (modeValue.get().toLowerCase()) {
            ...
            "heromc" -> if (thePlayer.hurtTime > 2 && thePlayer.onGround) {
