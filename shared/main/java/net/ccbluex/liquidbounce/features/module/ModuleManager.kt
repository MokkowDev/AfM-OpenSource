...
class ModuleManager : Listenable {
    ...
    fun registerModules() {
        ...
        ClientUtils.getLogger().info("Autodie for mossware >> Loaded ${modules.size} modules.")
    }
    ...
    fun registerModule(moduleClass: Class<out Module>) {
        try {
            ...
            ClientUtils.getLogger().error("Autodie for mossware >> Failed to load module: ${moduleClass.name} (${e.javaClass.name}: ${e.message})")
        }
    }
